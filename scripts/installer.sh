...
# CTS patch
patch_v30() {
  CTS_SYSTEM_EXT_BUILD_FINGERPRINT="ro.system.build.fingerprint=google/coral/coral:11/RQ1A.210105.003/7005429:user/release-keys"
  CTS_SYSTEM_EXT_BUILD_ID="ro.system.build.id=RQ1A.210105.003"
  CTS_SYSTEM_EXT_BUILD_TAG="ro.system.build.tags=release-keys"
  CTS_SYSTEM_EXT_BUILD_TYPE="ro.system.build.type=user"
  CTS_SYSTEM_BUILD_FINGERPRINT="ro.build.fingerprint=google/coral/coral:11/RQ1A.210105.003/7005429:user/release-keys"
  CTS_SYSTEM_BUILD_TYPE="ro.build.type=user"
  CTS_SYSTEM_BUILD_TAG="ro.build.tags=release-keys"
  CTS_SYSTEM_BUILD_DESC="ro.build.description=coral-user 11 RQ1A.210105.003 7005429 release-keys"
  CTS_PRODUCT_BUILD_FINGERPRINT="ro.product.build.fingerprint=google/coral/coral:11/RQ1A.210105.003/7005429:user/release-keys"
  CTS_PRODUCT_BUILD_ID="ro.product.build.id=RQ1A.210105.003"
  CTS_PRODUCT_BUILD_TAG="ro.product.build.tags=release-keys"
  CTS_PRODUCT_BUILD_TYPE="ro.product.build.type=user"
  CTS_EXT_BUILD_FINGERPRINT="ro.system_ext.build.fingerprint=google/coral/coral:11/RQ1A.210105.003/7005429:user/release-keys"
  CTS_EXT_BUILD_ID="ro.system_ext.build.id=RQ1A.210105.003"
  CTS_EXT_BUILD_TAG="ro.system_ext.build.tags=release-keys"
  CTS_EXT_BUILD_TYPE="ro.system_ext.build.type=user"
  CTS_VENDOR_EXT_BUILD_FINGERPRINT="ro.vendor.build.fingerprint=google/coral/coral:11/RQ1A.210105.003/7005429:user/release-keys"
  CTS_VENDOR_BUILD_FINGERPRINT="ro.build.fingerprint=google/coral/coral:11/RQ1A.210105.003/7005429:user/release-keys"
  CTS_VENDOR_BUILD_ID="ro.vendor.build.id=RQ1A.210105.003"
  CTS_VENDOR_BUILD_TAG="ro.vendor.build.tags=release-keys"
  CTS_VENDOR_BUILD_TYPE="ro.vendor.build.type=user"
  CTS_VENDOR_BUILD_BOOTIMAGE="ro.bootimage.build.fingerprint=google/coral/coral:11/RQ1A.210105.003/7005429:user/release-keys"
}
  ...
  if [ "$supported_setup_config" == "true" ]; then
    ...
    if [ "$android_sdk" == "$supported_sdk_v28" ]; then
      ZIP="
        ...
        zip/core/setupwizardprebuilt_lib64.tar.xz" && unpack_zip
    fi
