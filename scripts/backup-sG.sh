...
backupdirSYS() {
  SYS_APP="
    $S/app/FaceLock
    $S/app/GoogleCalendarSyncAdapter
    $S/app/GoogleContactsSyncAdapter"

  SYS_APP_JAR="
    $S/app/GoogleExtShared"

  SYS_PRIVAPP="
    $S/priv-app/AndroidPlatformServices
    $S/priv-app/ConfigUpdater
    $S/priv-app/GmsCoreSetupPrebuilt
    $S/priv-app/GoogleLoginService
    $S/priv-app/GoogleServicesFramework
    $S/priv-app/Phonesky
    $S/priv-app/PrebuiltGmsCore
    $S/priv-app/PrebuiltGmsCorePix
    $S/priv-app/PrebuiltGmsCorePi
    $S/priv-app/PrebuiltGmsCoreQt
    $S/priv-app/PrebuiltGmsCoreRvc
    $S/priv-app/PrebuiltGmsCoreSvc"

  SYS_PRIVAPP_JAR="
    $S/priv-app/GoogleExtServices"

  SYS_SYSCONFIG="
    $S/etc/sysconfig/google.xml
    $S/etc/sysconfig/google_build.xml
    $S/etc/sysconfig/google_exclusives_enable.xml
    $S/etc/sysconfig/google-hiddenapi-package-whitelist.xml
    $S/etc/sysconfig/google-rollback-package-whitelist.xml
    $S/etc/sysconfig/google-staged-installer-whitelist.xml"

  SYS_DEFAULTPERMISSIONS="
    $S/etc/default-permissions/default-permissions.xml"

  SYS_PERMISSIONS="
    $S/etc/permissions/privapp-permissions-atv.xml
    $S/etc/permissions/privapp-permissions-google.xml
    $S/etc/permissions/split-permissions-google.xml"
